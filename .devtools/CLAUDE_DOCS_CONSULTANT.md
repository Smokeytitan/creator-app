...
This guide explains how to efficiently consult official Claude Code documentation by fetching only the specific docs needed for the current task. Instead of loading all documentation upfront, determine which docs are relevant and fetch them on-demand.

## When to Use This Approach

Use selective documentation fetching when:
...
**Task:** "Help me create a pre-tool-use hook to log all tool calls"
...
**Task:** "My skill isn't loading - help me fix SKILL.md"
...
**Task:** "Which subagent should I use to search the codebase?"
...
**Task:** "How do I configure Claude Code settings.json?"
...
### Most Common Documentation URLs
...
### Command Template for Claude

```
"Help me create a [feature] using Claude Code.
Please fetch the relevant documentation from docs.claude.com
and show me how to implement it correctly."
```

## Integration with Development Toolkit

This documentation fetching approach integrates with the dev toolkit:

- Use with **dev-helper.sh** for interactive development sessions
- Reference when creating **custom hooks** for your project
- Apply when building **project-specific skills**
- Consult when debugging **Claude Code features**

## Additional Resources

- Official Claude Code: https://claude.com/code
- GitHub Issues: https://github.com/anthropics/claude-code/issues
- Documentation Home: https://code.claude.com/docs

---

**Note**: This is a documentation strategy, not a skill file. Use this guide to help Claude efficiently fetch and apply official documentation when needed.
